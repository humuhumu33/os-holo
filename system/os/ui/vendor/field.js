...
// ../../ui-main/ui-main/apps/v4/registry/new-york-v4/ui/field.tsx
...
// ../../ui-main/ui-main/apps/v4/registry/new-york-v4/ui/separator.tsx
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    return /* @__PURE__ */ jsx3("ul", { className: "ml-4 flex list-disc flex-col gap-1", children: uniqueErrors.map(
      (error, index) => error?.message && /* @__PURE__ */ jsx3("li", { children: error.message }, index)
    ) });
  }, [children, errors]);
  if (!content) {
    return null;
